...
Refer to context-entroy and context-window for a comprehensive look at context, and how to best manage it to ensure optimization. Ensure you use Tokens conservatively, and refer to context-token-limits for guidance on how to optimize token usage. 
